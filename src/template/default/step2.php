...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="overflow-auto p-3" style="height: 400px;">
            ...
            $dirfile = check_dirfile($config->get('dirfile@ebcms.installer', [
                ['dir', './upload', '可写', true],
                ['dir', $framework->getRoot() . '/config', '可写', true],
                ['dir', $framework->getRoot() . '/runtime', '可写', true],
                ['file', $framework->getRoot() . '/config/database.php', '可写', true],
            ]), $env_err);
            ?>
            <table class="table table-hover table-bordered">
                <thead>
            ...
            $func = check_func($config->get('func@ebcms.installer', [
                ['pdo', '支持', true, '类'],
